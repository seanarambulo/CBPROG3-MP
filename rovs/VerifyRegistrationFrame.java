...
import java.util.ArrayList;
    ...
    public class VerifyRegistrationFrame extends AbstractReservationFrame {
    protected DLSU_SRSAdmin_controller Acontroller;
    protected ArrayList<Student> students;
    public VerifyRegistrationFrame(DLSU_SRSAdmin_controller Acontroller, ArrayList<Student> students) {
