...
public class DLSU_SRSAdmin_controller {
    ...
    /* 
    public void ShuttleRouteMenu(){
        view.ShuttleRouteMenu(this);
    }
    */

    public void ADMINSRSFRAME_VIEWSHUTTLEROUTES(){
        try {
            view.ADMINSRSFRAME_VIEWSHUTTLEROUTES(this, dbManager.getShuttleRoutes());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
/*
    public void ADMINSRSFRAME_EDITSHUTTLEROUTES(){
        view.ADMINSRSFRAME_EDITSHUTTLEROUTES(this);
    }
*/
