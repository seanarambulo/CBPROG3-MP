...
public class presetBooking extends JFrame {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            presetBooking presetBookingFrame = new presetBooking();
            presetBookingFrame.setVisible(true);
        });
    }
}
...
class Reservation {
    ...
    public Reservation(String shuttleLine, String time, String origin, String destination) {
