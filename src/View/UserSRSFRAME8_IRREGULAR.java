...
public class UserSRSFRAME8_IRREGULAR extends FrameBackground {
    ...
    private IrregReservation booking;


    public UserSRSFRAME8_IRREGULAR(DLSU_SRSUser_controller controller, IrregReservation booking) {
        super();
...
private void handleSubmitAction() {
    ...
    System.out.println(booking.getReason() + "asssad");
    ...
    int timeID = controller.getTimeIDByTime(selectedTime);
        controller.insertBooking(false,booking.getOrigin(),booking.getDestination(),selectedDate, lineID,controller.getUserID_userController(),timeID,booking.getReason(),false);
